sap.ui.define([
	...
	opaTest("MasterList Filtering on RESTRICTION_REASON_ID less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("RESTRICTION_REASON_ID").
		and.iSelectListItemInViewSettingsDialog("<100 RESTRICTION_REASON_ID").
	...
	opaTest("MasterList Filtering on RESTRICTION_REASON_ID more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 RESTRICTION_REASON_ID").
		and.iPressOKInViewSelectionDialog();
