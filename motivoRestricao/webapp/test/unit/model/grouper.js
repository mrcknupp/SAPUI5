sap.ui.define([
	...
	function createResourceModel() {
		return new ResourceModel({
			bundleUrl: [$.sap.getModulePath("com.cpfl.motivorestricao"), "i18n/i18n.properties"].join("/")
		});
	}
	...
	QUnit.test("Should group a price lesser equal 20", function(assert) {
		...
		// System under test
		var fnGroup = Grouper.RESTRICTION_REASON_ID(this._oResourceModel.getResourceBundle());
