/*global history */
sap.ui.define([
	"com/cpfl/motivorestricao/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/cpfl/motivorestricao/model/formatter",
	"sap/m/MessageBox",
	"com/cpfl/motivorestricao/model/grouper",
	...
	return BaseController.extend("com.cpfl.motivorestricao.controller.Master", {
		...
		onInit: function() {
			...
			this._oGroupSortState = new GroupSortState(oViewModel, grouper.RESTRICTION_REASON_ID(this.getResourceBundle()));
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.cpfl.motivorestricao.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "Filter1":
						aFilters.push(new Filter("RESTRICTION_REASON_ID", FilterOperator.LE, 100));
						break;
					case "Filter2":
						aFilters.push(new Filter("RESTRICTION_REASON_ID", FilterOperator.GT, 100));
						break;
					default:
						break;
				}
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							RESTRICTION_REASON_ID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("RESTRICTION_REASON_ID"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				RESTRICTION_REASON_ID: encodeURIComponent(oItem.getBindingContext().getProperty("RESTRICTION_REASON_ID"))
			}, bReplace);
		},
