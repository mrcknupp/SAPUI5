sap.ui.define([
	...
	return BaseController.extend("com.cpfl.motivorestricao.controller.CreateEntity", {
		...
		onSave: function() {
			...
			if (this._oViewModel.getProperty("/mode") === "edit") {
				...
				oModel.read("/genRestrictionReasonId",{
					success: function(oResponseSucess){
						
						var modelData = that.getView().getBindingContext().getObject();
						modelData.RESTRICTION_REASON_ID = oResponseSucess.results[0].GEN_RESTRICTION_REASON_ID;
//						oModel.submitChanges();
						oModel.create("/motivoRestricaoOData",modelData, {
							success : function(oData, response){
								MessageToast.show(that._oResourceBundle.getText("motivoCriadoComSucesso"));
				            },
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("motivoRestricaoOData", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("motivoRestricaoOData", oData);
