...
sap.ui.define([
	...
	return BaseController.extend("com.cpfl.motivorestricao.controller.Detail", {
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("motivoRestricaoOData", oParameter);
		...
		_onBindingChange: function() {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.RESTRICTION_REASON_ID,
