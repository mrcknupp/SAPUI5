sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/cpfl/canalnot/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#CanalNoficacao-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#CanalNoficacao-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.cpfl.canalnot.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/cpfl/canalnot/localService/mockserver"], function (mockserver) {
