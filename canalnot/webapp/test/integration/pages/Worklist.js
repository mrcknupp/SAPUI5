sap.ui.define([
		...
		"com/cpfl/canalnot/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all Canal_Notificacao_Odata to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "Canal_Notificacao_Odata",
