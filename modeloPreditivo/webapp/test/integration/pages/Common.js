sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/cpfl/modelos/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#CadastroModeloPreditivo-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#CadastroModeloPreditivo-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.cpfl.modelos.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/cpfl/modelos/localService/mockserver"], function (mockserver) {
