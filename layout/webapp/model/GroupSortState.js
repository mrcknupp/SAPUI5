sap.ui.define([
	...
	return BaseObject.extend("com.cpfl.layout.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.cpfl.layout.model.GroupSortState
		 */
		...
		/**
		 * Groups by LAYOUT_ID, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function(sKey) {
			...
			if (sKey === "LAYOUT_ID") {
				...
				this._oViewModel.setProperty("/sortBy", "LAYOUT_ID");

				aSorters.push(
					new Sorter("LAYOUT_ID", false,
